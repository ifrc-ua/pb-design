# Design System — Бюджет участі Івано-Франківської громади
...
Шрифт Proxima Nova — універсальна робоча гарнітура. Віповідає за щільні шари інтерфейсу, аналітичні підписи, довгі описи проєктів і таблиці даних.
