...
> [!WARNING]
> **Триває очищення даних.** Зараз формується вивірений набір даних бюджету участі за всіма наявними параметрами. Тому числові приклади в дизайн-системі є **умовними й непідтвердженими**.

## Що тут є

- **[design.md](./design.md)** — дизайн-**система**: кольори, типографіка, компоненти, правила.
- **[design-data.md](./design-data.md)** *(beta)* — **шар даних**: реальні категорії БУ за роками (2016–2026), канонічна палітра категорій, статуси проєктів, мап-токени. Може змінюватися після перегляду громадою.
- **Шрифти:** [Phenomena](https://www.fontfabric.com/fonts/phenomena/) (заголовки, безкоштовний для використання, але redistribution заборонено) і Proxima Nova (текст/UI, комерційний) — файли не включені до репозиторію.
...
- **Інші агенти**: більшість приймає system-prompt або «rules» файлю Направте його на `design.md` один раз.
...
<sub>*Дані в зразках призначені суто для дизайн-цілей, а не для аналітики. Усі числа в рендерах — це орієнтовні значення для перевірки стилю та композиції, а не джерело статистики.*</sub>
