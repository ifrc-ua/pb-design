...
<sub>*Дані в зразках — для дизайн-цілей, не для аналітики. Усі числа в рендерах — орієнтовні значення для перевірки стилю та композиції, а не джерело статистики.*</sub>
