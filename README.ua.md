...
> [!WARNING]
> 🟡 **Триває очищення даних.** Зараз формується вивірений набір даних бюджету участі за всіма наявними параметрами. Тому числові приклади в дизайн-системі є **умовними й непідтвердженими**. Щойно аналітичну частину буде завершено, приклади замінять на реальні значення з відповідною приміткою.
