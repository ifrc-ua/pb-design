...
- **[design-data.md](./design-data.md)** *(beta)* — **шар даних**: реальні категорії БУ за роками (2016–2026), канонічна палітра категорій, статуси проєктів, мап-токени. Може змінюватися до погодження мерією.
