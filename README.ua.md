...
- **Явне «out of scope»** — dark mode, активне голосування, адмін-UI і форми подачі свідомо не дизайнуються. AI-агенти залишають маркер `<!-- TODO: design-data.md -->` замість того щоб фабрикувати.
