...
- **[design-data.md](./design-data.md)** — **шар даних**: реальні категорії БУ за роками (2016–2026), канонічна палітра категорій, статуси проєктів, мап-токени. Стабільний (v1.0.0) — палітра фіналізована й затверджена власником проєкту.
